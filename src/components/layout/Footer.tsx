      ...
      <div className="max-w-7xl mx-auto section-padding py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="font-heading text-3xl font-semibold text-white tracking-wide">
              LUXELUSH
            </h3>
            <p className="text-neutral-400 font-body text-sm leading-relaxed max-w-xs">
              {BRAND.description}
            </p>
            {/* Social Icons */}
            <div className="flex items-center gap-4 pt-2">
              <a
                ...
                className="text-neutral-400 hover:text-brand-gold-500 transition-colors"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-green-600 text-white px-5 py-2.5 rounded-full text-sm font-body font-medium hover:bg-green-700 transition-colors"
              >
